...
/// Wrapper for Picker to include PickerStyle and fix some issues.
///
///	- FB13208225: setting the pickerStyle causes only the picker part to be tappable.
///	Setting .pickerStyle() to .menu (instead of .automatic, which is .menu on iOS) causes only the picker part to be tappable.
